...
// function objectsEqual(received, expected) {
//     if (isPrimitive(received)) {
//         const result = received === expected;
//         const isExpectedPrimitive = isPrimitive(expected);
//         if (result) {
//             return {
//                 pass: true;
//                 message: 'Objects are equal primitives'
//             }
//         }
//         if (isExpectedPrimitive) {
//             return {
//                 pass: false,
//                 message: `Objects ${received} and ${expected} are not equal primitives`
//             }
//         }
//         return {
//             pass: false,
//             message: 'Received object is a primitive, '
//         }
//         }
//     }
